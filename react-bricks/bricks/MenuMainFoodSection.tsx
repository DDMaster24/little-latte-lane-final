...
//========================================
// Menu Main Food Section Component
// Exact replica of "Main Food" section from current menu page
//========================================

interface MenuMainFoodSectionProps {
...
const MenuMainFoodSection: types.Brick<MenuMainFoodSectionProps> = ({
  // Content
  sectionTitle,
  leftEmoji,
  rightEmoji,
...
MenuMainFoodSection.schema = {
  name: 'menu-main-food-section',
  label: 'Menu Main Food Section',
...
export default MenuMainFoodSection