...
export async function performCheckout(
  ...
  specialInstructions?: string // Add special instructions parameter
) {
  try {
    ...
    const { data: orderRecord, error: orderError } = await supabase
      ...
      .insert({
        ...
        delivery_method: _deliveryType, // Now using the delivery type parameter
        special_instructions: specialInstructions || null, // Add special instructions to order
