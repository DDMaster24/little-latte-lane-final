...
const CSP_DIRECTIVES = [
  "default-src 'self'",
  `script-src 'self' 'unsafe-inline' ${process.env.NODE_ENV === 'development' ? "'unsafe-eval'" : ''} blob: https://vercel.live https://*.vercel.live https://*.sentry.io https://api.reactbricks.com https://*.yoco.com https://js.yoco.com`,
  "script-src-elem 'self' 'unsafe-inline' blob: https://vercel.live https://*.vercel.live https://*.sentry.io https://api.reactbricks.com https://*.yoco.com https://js.yoco.com",
  "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",
  "font-src 'self' https://fonts.gstatic.com",
  "img-src 'self' data: blob: https:",
  "connect-src 'self' data: wss: https://awytuszmunxvthuizyur.supabase.co wss://awytuszmunxvthuizyur.supabase.co https://registry.npmjs.org https://www.google-analytics.com https://*.google-analytics.com https://analytics.google.com https://*.googletagmanager.com https://overbridgenet.com https://*.sentry.io https://vercel.live https://*.vercel.live https://api.reactbricks.com https://*.reactbricks.com https://*.yoco.com https://api.yoco.com https://payments.yoco.com",
  "worker-src 'self' blob:",
  "child-src 'self' blob: https://vercel.live https://*.vercel.live",
  "frame-src 'self' blob: https://vercel.live https://*.vercel.live https://*.yoco.com https://payments.yoco.com",
